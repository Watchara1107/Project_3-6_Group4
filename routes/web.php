...
Route::post('/admin/categories/create','admin\CategoriesController@create')->name('create.category');
...
Route::post('/admin/products/create','admin\ProductsController@create')->name('create');
...
Route::post('/admin/promotes/create','admin\PromotesController@create')->name('create');
...
//customer
Route::get('/admin/customers/index' , 'admin\CustomersController@index')->name('customers');
